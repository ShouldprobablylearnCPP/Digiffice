Digiffice is an open-source Office Program. It is currently pre-release, (in fact, very early development) but I would like to build some traction early. Here is why I am creating Digiffice and why it should be usable.

=== 1 - No Unnecessary bloat ===
...
- The master branch and other branches will only contain the needed source code, which means IP addresses that connect to servers in the software will not be declared/present in the source code.
...
| **RAM Usage** | ~100MB | 400MB+ |
| **Install Size** | ~20MB | 500MB - 2GB |
| **File size (~100 words text)** | ~0.9KB (.dgan) | ~4.2KB (.onepkg) |
| **File size (1080p image)** | ~420KB (.dgan) | ~640KB (.onepkg) |

Specs of tested computer: Ryzen 7 5800X (8 cores, 16 threads), 32GB Memory, Nvidia RTX 3060, Tested on Windows 11
...
If you have made it to this point so far, thank you for reading this. Feel free to check out the project and explore this project of mine :)
